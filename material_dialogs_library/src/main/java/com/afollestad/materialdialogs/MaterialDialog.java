...
public class MaterialDialog extends DialogBase implements View.OnClickListener {
    ...
    MaterialDialog(Builder builder) {
        ...
        if (!getContext().getResources().getConfiguration().locale.getLanguage().equals("ar")) {
            this.regularFont = Typeface.createFromAsset(getContext().getResources().getAssets(), "clanot_news.otf");
            this.mediumFont = Typeface.createFromAsset(getContext().getResources().getAssets(), "clanot_medium.otf");
        } else {
            this.regularFont = Typeface.createFromAsset(getContext().getResources().getAssets(), "ge_ss_text_light.otf");
            this.mediumFont = Typeface.createFromAsset(getContext().getResources().getAssets(), "ge_ss_text_medium.otf");
        }
        ...
        if (this.positiveColor == 0) {
            content.setLinkTextColor(Utils.resolveColor(getContext(), R.attr.material_button_color));
        } else {
        ...
        if (builder.title == null || builder.title.toString().trim().isEmpty()) {
            ...
            if (isAscii(title.getText().toString())) {
                title.setTypeface(Typeface.createFromAsset(getContext().getResources().getAssets(), "clanot_medium.otf"));
            } else {
                title.setTypeface(Typeface.createFromAsset(getContext().getResources().getAssets(), "ge_ss_text_medium.otf"));
            }
    ...
    private void invalidateList() {
        ...
        for (int index = 0; index < items.length; index++) {
            ...
            if (listCallbackSingle != null) {
                ...
                RadioButton radioButton = (RadioButton) il.findViewById(R.id.control);
                if (index == selected) {
    ...
    private void invalidateActions() {
        ...
        if (this.negativeText != null) {
            ...
            negativeButton.setTextColor(getContext().getResources().getColor(R.color.gray_negative));
    ...
    public final void onClick(View v) {
        ...
        if (tag.equals(POSITIVE)) {
            if (listCallbackSingle != null) {
                ...
                listCallbackMulti.onSelection(this, selectedIndices.toArray(new Integer[selectedIndices.size()]),
    ...
    private ColorStateList getActionTextStateList(int newPrimaryColor) {
        final int buttonColor = Utils.resolveColor(getContext(), R.attr.material_button_color);
        if (newPrimaryColor == 0) {
            newPrimaryColor = buttonColor;
        }
        int[][] states = new int[][]{new int[]{-android.R.attr.state_enabled}, // disabled
                new int[]{} // enabled
        };
        int[] colors = new int[]{Utils.adjustAlpha(buttonColor, 0.6f), newPrimaryColor};
    ...
    public static class Builder {
        ...
        public Builder content(
                @StringRes
                int contentRes, Object... formatArgs) {
        ...
        public Builder itemsCallbackSingleChoice(int selected, ListCallback callback) {
        ...
        public Builder positiveColorRes(
                @ColorRes
                int colorRes) {
